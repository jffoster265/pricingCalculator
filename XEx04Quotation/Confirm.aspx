        ...
        <main class="container">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                   <asp:Button ID="btnQuotation" runat="server" Text="Send Quotation"
                         CssClass="btn btn-primary" OnClick="btnQuotation_Click" />
                    <%-- confirm button goes here --%>
                     <asp:Button ID="btnReturn" runat="server" Text="Return"
                         CssClass="btn btn-primary" OnClick="btnReturn_Click" PostBackUrl="~/Default.aspx" />
                </div>
            </div> 
            ...
            <div class="form-group">
                <div class="col-sm-offset-1 col-sm-11">
                    ...
                    <asp:Label ID="lblMessage" runat="server" CssClass="text-info">Click the Send Quotation button to send the quotation via email</asp:Label>
                </div>
            </div>
